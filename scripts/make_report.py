...
\section{Conclusion}
The conclusion is drawn from the frozen out-of-sample evidence in Section~\ref{sec:oos} and the analysis sections; it is deliberately not restated here as a template, and no claim is made that is not supported by the reported tables and figures.
